...
Name: Mirrors4_5  | IP ADDR: 192.168.1.106 | UNIVERSE(s): 8,9  | NUM LEDS: 206 | DIMENSIONS: 17, 17, 18, 17, 17, 17, 18, 17, 17, 17, 17, 18 
*/
#include <ArtnetWifi.h>
#include <Arduino.h>
#include <Adafruit_NeoPixel.h>

#define DEVICE_NAME "Mirrors1_2"
IPAddress ip(192,168,1,136);
const int num_universes = 1;
const int universes[num_universes] = {5};
const int leds_per_universe[num_universes] = {137};
